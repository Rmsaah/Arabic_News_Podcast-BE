...
/**
 * REST controller for homepage and discovery features.
 * Provides endpoints for featured content and recommendations.
 */
@RestController
...
public class HomeController {
    ...
    /**
     * Get daily featured episodes for the homepage.
     * Returns a curated list of episodes for user discovery.
     *
