...
/**
 * DTO for JSON-based episode import with nested entity structure. This represents a complete
 * episode with explicit Article, Audio, and Episode data.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class EpisodeJsonDto {
  ...
  public static class EpisodeData {
    ...
    private String
        scriptUrlPath; // // URL to script (optional, uses article.scriptUrl if not provided)
