...
public interface UserService {
  ...
  /**
   * Register a new user in the system. Assigns default ROLE_USER and encrypts password.
   *
  ...
  /**
   * Retrieve user information by their unique identifier. Validates that the requesting user has
  ...
  /**
   * Update a user's first and last name. Validates that the requesting user has permission to
   * update this profile.
   *
   * @param userId The unique identifier of the user
